class LRUCache {
    ...
    //Deque manages its elements with a dynamic array, provides random access, and has almost the same interface as a vector List manages its elements as a doubly linked list and does not provide random access.
    int capacity;
public:
